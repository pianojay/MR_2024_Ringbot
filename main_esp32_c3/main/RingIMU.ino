...
#define intPin 0    // These can be changed, 2 and 3 are the Arduinos ext int pins
#define blinkPin 1  // Blink LED when updating
#define SDAPin 5    // I2C clock line
#define SCLPin 6    // I2C data line
